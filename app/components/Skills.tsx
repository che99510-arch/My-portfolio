      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-16">
          ...
          <p className="text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
            A snapshot of my technical skillset built through years of real-world projects.
          </p>
        ...
        <div className="grid sm:grid-cols-2 gap-8">
          {skillGroups.map((group, gi) => (
            <FadeIn key={group.category} delay={gi * 0.1}>
              <div className="bg-white dark:bg-[#1e293b] rounded-2xl p-6 border border-gray-100 dark:border-gray-700/50 shadow-lg hover:shadow-blue-500/10 transition-shadow">
                <div className="flex items-center gap-3 mb-6">
                  <div className={`w-3 h-8 rounded-full bg-gradient-to-b ${group.color}`} />
                  <h3 className="font-black text-gray-900 dark:text-white text-lg">{group.category}</h3>
                </div>
