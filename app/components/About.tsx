...
import { CheckCircle2, Briefcase, GraduationCap, Heart } from "lucide-react";
...
const cards = [
  {
    Icon: Briefcase,
    title: "Professional",
    desc: "Delivering enterprise-grade solutions that scale.",
    color: "from-blue-500 to-blue-700",
  },
  {
    Icon: GraduationCap,
    title: "Experienced",
    desc: "3 years building digital products for real businesses.",
    color: "from-indigo-500 to-blue-600",
  },
  {
    Icon: Heart,
    title: "Passionate",
    desc: "Genuinely care about quality and client success.",
    ...
    <section id="about" className="section-padding bg-gray-50 dark:bg-[#0a1628] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <FadeIn className="text-center mb-16">
          ...
          <div className="w-16 h-1 bg-gradient-to-r from-blue-600 to-blue-400 rounded-full mx-auto" />
        </FadeIn>
          ...
          <FadeIn delay={0.1}>
            <div className="relative">
              ...
              <div className="relative rounded-3xl overflow-hidden gradient-border shadow-2xl">
                <div className="bg-gradient-to-br from-[#1e3a8a] to-[#1e40af] p-8 sm:p-12">
                  {/* Code snippet visual */}
                  <div className="bg-[#0f1629]/80 rounded-2xl p-6 font-mono text-sm">
